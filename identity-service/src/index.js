...
// STUB: returns a fake token; a real implementation would verify
// credentials and sign a JWT.
...
app.listen(PORT, () => console.log(`Identity service (stub) listening on ${PORT}`));
